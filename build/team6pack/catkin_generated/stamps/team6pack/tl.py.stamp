...
def main():
    ...
    while not rospy.is_shutdown():
        ...
        msg_chatter_2_data = "hello_world v2"
        msg_chatter_2 = String()
        msg_chatter_2.data = msg_chatter_2_data
        pub_sub_node.pub_chatter_2.publish(msg_chatter_2)
        rospy.loginfo("I sent %s", msg_chatter_2_data)
